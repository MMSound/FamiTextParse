This is a small utility that parses a FamiTracker (or other fork) .txt file into an organized .json file. This could possibly be used for making conversions of FT modules to other formats.
